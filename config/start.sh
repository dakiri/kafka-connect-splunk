...
addhost "kafka-connect" "192.168.2.38"


/opt/splunk-kafka-connect/bin/connect-distributed.sh  /opt/splunk-kafka-connect/config/connect-distributed-quickstart.properties
